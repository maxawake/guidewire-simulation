...
namespace GuidewireSim
{
    ...
    public class SimulationLoop : MonoBehaviour
    {
        ...
        float rodElementLength = float.Parse(System.Environment.GetCommandLineArgs()[1]); /**< The distance between two spheres, also the distance between two orientations. Change it to float and use the [1] to prohibit type errors.
