...
public class SimulationLooCopy : MonoBehaviour
{
    ...
    [Range(1, 1000)] public int constraintSolverSteps = 1000; /**< How often the constraint solver iterates over each constraint during
                                                                                 *   the Constraint Solving Step.
                                                                                 *   @attention This value must be positive.
                                                                                 */
    [Range(0.002f, 0.04f)] public float timeStep = 0.01f; /**< The fixed time step in seconds at which the simulation runs.
    ...
    */
    ...
    private void PerformConstraintSolvingStep()
    {
        ...
        {            
            ...
            if (solveStretchConstraints)
            {
                Debug.Log("Solving Stretch Constraints");
                Debug.Log(spherePositionPredictions);
                Debug.Log(cylinderOrientationPredictions);
                Debug.Log(SpheresCount);
                Debug.Log(worldSpaceBasis);
                Debug.Log(rodElementLength);
    ...
    */
    ...
    public void SetSpheres(GameObject[] spheresArray)
    {
        ...
        Debug.Log("Spheres Count: " + SpheresCount);
    }
    ...
    public void SetCylinders(GameObject[] cylindersArray)
    {
        ...
        Debug.Log("Cylinder Count: " + CylinderCount);
    }
