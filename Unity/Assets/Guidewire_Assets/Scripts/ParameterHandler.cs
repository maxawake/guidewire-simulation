...
namespace GuidewireSim {
    ...
    {   
        ...
        public int constraintSolverSteps = 1000; /**< How often the constraint solver iterates over each constraint during
                                                                                 *   the Constraint Solving Step.
                                                                                 *   @attention This value must be positive.
                                                                                 */
        public float timeStep = 0.01f; /**< The fixed time step in seconds at which the simulation runs.
